...
![Last Update](https://img.shields.io/badge/Last%20Update-2026--03--02%2000:30:35%20UTC-blue)
...
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/maxmind/GeoIP2-City.mmdb

# GeoIP2 Country Database
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/maxmind/GeoIP2-Country.mmdb

# GeoIP2 ISP Database
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/maxmind/GeoIP2-ISP.mmdb

# GeoIP2 Connection Type Database
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/maxmind/GeoIP2-Connection-Type.mmdb
```
...
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/ip2location/IP-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ISP-DOMAIN-MOBILE-USAGETYPE.BIN

# IP2Location IPv6 Database
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/ip2location/IPV6-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ISP-DOMAIN-MOBILE-USAGETYPE.BIN

# IP2Proxy IPv4 Database
curl -O https://your-geoip-bucket.s3.amazonaws.com/raw/ip2location/IP2PROXY-IP-PROXYTYPE-COUNTRY.BIN
```
...
- MaxMind: `https://your-geoip-bucket.s3.amazonaws.com/compressed/maxmind/[database-name].tar.gz`
- IP2Location: `https://your-geoip-bucket.s3.amazonaws.com/compressed/ip2location/[database-name].zip`

## 📊 Database Information

| Database | Provider | Format | Size | Description |
|----------|----------|--------|------|-------------|
| GeoIP2-City | MaxMind | MMDB | 118MB | City-level IP geolocation data |
...
| DB23 IPv4 | IP2Location | BIN | 631MB | Comprehensive IPv4 geolocation data |
| DB23 IPv6 | IP2Location | BIN | 810MB | Comprehensive IPv6 geolocation data |
| PX2 IPv4 | IP2Location | BIN | 360MB | IPv4 proxy detection data |
...
- [S3 Bucket](https://your-geoip-bucket.s3.amazonaws.com/)

---

**Last Update:** 2026-03-02 00:30:35 UTC
