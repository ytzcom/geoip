...
By default, the workflow uses the `your-geoip-bucket` S3 bucket. To use a different bucket:
...
- `S3_BUCKET`: Your S3 bucket name (defaults to `your-geoip-bucket`)
...
- [Default S3 Bucket](https://your-geoip-bucket.s3.amazonaws.com/)
