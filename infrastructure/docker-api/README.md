...
| `S3_BUCKET` | S3 bucket name (for s3/hybrid modes) | `your-geoip-bucket` |
...
import boto3
s3 = boto3.client('s3')
print(s3.list_objects_v2(Bucket='your-geoip-bucket', MaxKeys=1))
"
```
